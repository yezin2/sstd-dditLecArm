...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
      	<div class="card">
      		<div class="card-header">1header</div>
      		<div class="card-body">1body</div>
      		<div class="card-footer">1footer</div>
      	</div>
      	<div class="row">
      		<div class="col-sm-6">
      			<div class="card col-normal-12">
      				<div class="card-body">2-1body</div>
	      		</div>
      		</div>
      		<div class="col-sm-6">
	      		<div class="row">
	      			<div class="col-sm-8">
	      				<div class="card">
	      					<div class="card-body">2-2body</div>
	      				</div>
		      		</div>
		      		<div class="col-sm-4">
		      			<div class="card">
