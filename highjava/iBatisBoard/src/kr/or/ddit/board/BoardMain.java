...
import kr.or.ddit.board.service.BoardImpl;
import kr.or.ddit.board.vo.BoardVO;
	...
	*/
	...
	public class BoardMain {
		...
		public BoardMain() {
			memService = BoardImpl.getInstance();
		}
		...
		private void searchMember() {
			...
			String memId = scan.nextLine().trim();//trim() : 의미없는 공백제거

			System.out.print("회원이름 >> ");
			String memName = scan.nextLine().trim();//trim() : 의미없는 공백제거

			System.out.print("전화번호 >> ");
			String memTel = scan.nextLine().trim();//trim() : 의미없는 공백제거

			System.out.print("주소 >> ");
			String memAddr = scan.nextLine().trim();//trim() : 의미없는 공백제거
			...
			List<BoardVO> memList = memService.getSearchMember(mv);
...
//			int cnt = memService.getSearchMember(memId);
			
//			if(cnt > 0) {
//				System.out.println(memId + "회원정보 검색 작업 성공");
//			}else {
//				System.out.println(memId + "회원정보 검색 작업 실패!!!");
//			}
		}
		...
		private void displayAll() {
			...
			List<BoardVO> memList = memService.getAllMemberList();
