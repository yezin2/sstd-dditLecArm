 ...
 * HttpservletRequest를 싸서 다른기능을 덧붙임
 */
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
    ...
    throws FileUploadException{
    	//(memoryThreshold, fileSizeMax, maxRequestSize, repositoryPath)이 들을 default로 설정들을 초기화 해줌
    	//this 생성자
    ...
    private void parsing(HttpServletRequest request,
        ...
        if (ServletFileUpload.isMultipartContent(request)) {//multipart일때만 동작함
            ...
            // 위에서는 servletFileUpload를 초기화 작업을 한것이고
            // 아래부터는 파싱작업을 시작함
